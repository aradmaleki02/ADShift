...
from dataset import AugMixDatasetMVTec, get_data_transforms, prepare_br35h_dataset_files, \
    prepare_brats2015_dataset_files, BrainTrain, APTOS
import argparse
...
def train(_class_, backbone, batch_size, epochs, save_step, image_size, cp_path):
    ...
    for epoch in (range(epochs)):
        ...
        if (epoch + 1) % save_step == 0:
            ...
            result = subprocess.run(["python", "eval_aptos.py"] + arguments_to_pass, capture_output=False, text=True)
...
if __name__ == '__main__':
    ...
    train('aptos', args.backbone, args.batch_size, args.epochs, args.save_step, args.image_size, args.cp_path)
